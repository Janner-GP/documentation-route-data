...
![VPC Entrance](pathname:///img/vpc/1.png)

* **Seleccionar → Create VPC**

![VPC_Entrance](pathname:///img/vpc/VPC_1.png)

* **Configurar el Nombre de la VPC y un IPv4 CIDR (Ej: 10.0.0.0/16)**

![VPC_Entrance](pathname:///img/vpc/VPC_2.png)
![VPC_Entrance](pathname:///img/vpc/VPC_3.png)
...
![VPC_Entrance](pathname:///img/vpc/INTERNET_1.png)

* **Asignar el Nombre y Crear**

![VPC_Entrance](pathname:///img/vpc/INTERNET_2.png)

* **Seleccionar en el menú actions → Attach to VPC**

![VPC_Entrance](pathname:///img/vpc/INTERNET_3.png)

* **Attachment a la VPC creada**

![VPC_Entrance](pathname:///img/vpc/INTERNET_4.png)
...
![VPC_Entrance](pathname:///img/vpc/ROUTE_1.png)

* **Configurar el Nombre de la ruta**

![VPC_Entrance](pathname:///img/vpc/ROUTE_2.png)

* **Seleccionar → Edit Route**

![VPC_Entrance](pathname:///img/vpc/ROUTE_3.png)

* **Seleccionar → Add Route**

![VPC_Entrance](pathname:///img/vpc/ROUTE_4.png)

* **Añadir la ruta Destination: 0.0.0.0/0  y Conectarla con el Internet Gateway Creado previamente**

![VPC_Entrance](pathname:///img/vpc/ROUTE_5.png)

* **Asociación a la subnet publica: seleccionar actions → Edit Subnet associations**

![VPC_Entrance](pathname:///img/vpc/ROUTE_6.png)

* **Attachment a la subnet pública**

![VPC_Entrance](pathname:///img/vpc/ROUTE_7.png)
...
![VPC_Entrance](pathname:///img/vpc/SECURITY_1.png)
...
![VPC_Entrance](pathname:///img/vpc/SECURITY_2.png)
...
![VPC_Entrance](pathname:///img/vpc/SECURITY_3.png)
